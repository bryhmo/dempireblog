  ...
  <footer id="footer" class="footer">
    ...
    <div class="footer-content">
      <div class="container">
        ...
        <div class="row g-5">
          <div class="col-lg-4">
            <h3 class="footer-heading">About D Empire Blog</h3>
            <p>D Empire is the best blog website to give you the best news and latest update about whats up in recent time ... keeping all our viewers updated is our first priority ?</p>
      ...
      <div class="container">
        ...
        <div class="row justify-content-between">
          <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
            <div class="copyright">
              © Copyright <strong><span>D Empire Blog</span></strong>. All Rights Reserved
            </div>
            ...
            <div class="credits">
              ...
              Designed by <a href="https://bootstrapmade.com/">D Empire Blog Teams </a>
            </div>
